...
function sendWarningEmailToUser($user)
{
	...
	$message .= "Nous n'avons toujours pas reçu ton paiement pour le weekend JSP. Tu t'étais engagé au moment de ton inscription à nous donner tes chèques sous une semaine et tu as eu un peu de délai grâce à la campagne Kès avant que nous te relancions, mais voilà, il faut bien que tu paies un jour ! Tu as donc jusqu'à mardi midi (dans notre grande générosité nous ne mettons pas la deadline lundi midi pour ceux qui ne rentreraient que l'après-midi de weekend !) pour nous donner tes chèques, sans quoi ton inscription sera annulée et ta place donnée à une personne sur liste d'attente.<br/><br/>";
