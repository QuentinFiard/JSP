...
<div class="content" id="inscriptionContent">
	...
	<div class="wrapper">
		<div class="title">Inscription à la semaine du réveillon</div>
		<div class="content">
			<h2>Rappel des informations essentielles</h2>
			<div class="summary first">
				<div class="title">Prix de base :</div>
				<div class="value"><?php echo SemaineReveillon::shared()->priceForUser($user) ?> €</div>
			</div>
			<div class="summary">
				<div class="title">Caution :</div>
				<div class="value"><?php echo SemaineReveillon::shared()->cautionForUser($user) ?> €</div>
			</div>
			...
			<form method="post" action="<?php 
				...
				<input class="primaryButton" type="submit" onclick="" value="S'inscrire" />
			</form>
		</div>
	</div>
</div>