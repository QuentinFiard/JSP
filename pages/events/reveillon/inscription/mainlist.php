...
<div class="alert_box_wrapper">
	<div class="alert_box reservation_status">
		...
		<div class="content_wrapper">
			<div class="subtitle">
				Félicitations, tu es inscrit sur liste principale pour la semaine du réveillon ! N'oublie pas de nous apporter ou de nous envoyer tes chèques le plus rapidement possible, si nous ne les avons pas reçus sous <b><?php if($user->isX()) {?>une<?php } else {?>2<?php }?> semaine<?php if(!$user->isX()) {?>s<?php } ?></b> nous donnerons ta place à une personne en liste d'attente.
			</div>
