...
<div class="alert_box_wrapper" id="forgottenPasswordBox">
	<div class="alert_box reservation_status">
		...
		<div class="content_wrapper">
			<div class="subtitle">
				Il ne reste malheureusement plus de places disponibles pour la semaine du réveillon. Tu es cependant inscrit(e) en liste d'attente et nous te contacterons dès qu'une place se libère ! Nous ferons passer en priorité les personnes qui nous auront transmis leurs chèques, donc n'oublie pas de nous les apporter au plus vite.
			</div>
